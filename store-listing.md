# Store Listing: Gita Wisdom New Tab

- **Name:** Gita Wisdom New Tab
- **Summary:** The complete Bhagavad Gita on your new tab: all 701 verses in Sanskrit with transliteration and a public-domain English translation.
- **Category:** Lifestyle
- **Language:** English
...
Replaces the new tab page with a dashboard that shows Bhagavad Gita verses in Sanskrit with transliteration, an English translation and text-to-speech reading.

## Permissions Justifications:
- **storage** — "Required to locally persist user preferences, theme selection, and bookmarked favorite shlokas on device."
